...
const mesasData = [
  {
    ...
    publico: true,
    descricao:
      'Campanha do jogo "Call of Cthulhu", edição de aniversário! Nosso grupo está completando 10 anos de CoC. No final do mês abriremos vagas para novos jogadores. Fiquem no aguardo!',
  ...
  },
  {
    ...
    publico: true,
    descricao:
      "Revivendo uma aventura de Arton! Jogadores interessados devem entrar em contato com email@gmail.com Data limite: 25/08/1994 Horário das partidas: 22 horas.",
    imagem: "https://placehold.co/135x170.png",
    status: "Há Vagas",
    url: "https://placehold.co/135x170.png"
  }
    ...
    return `
      <div class="table-card section ${
        mesa.status === "Lotado" ? "status-full" : "status-available"
           ...
           onclick="${
             mesa.status !== "Lotado" ? `window.location = '${mesa.url}'` : ""
           }">
